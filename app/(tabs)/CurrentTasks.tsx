...
export default function CurrentTasks() {
    ...
    // Group AFTER search
    const groupedTasks = {
        Today: filteredTasks.filter((t) => t.section === "Today" && !t.completed),
        Tomorrow: filteredTasks.filter((t) => t.section === "Tomorrow" && !t.completed),
        "This week": filteredTasks.filter((t) => t.section === "This week" && !t.completed),
    };
